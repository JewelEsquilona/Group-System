...
try {
    $statement = $con->query("
        ...
        FROM `2024-2025` a
        LEFT JOIN `2024-2025_ed` e ON a.`Alumni_ID_Number` = e.`Alumni_ID_Number`
    ");
                        ...
                        <?php if ($statement->rowCount() > 0): ?>
                            <?php while ($row = $statement->fetch(PDO::FETCH_ASSOC)): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($row['Alumni_ID_Number']); ?></td>
                                    ...
                                    <td>
                                        <a href="alumni_edit.php?Id=<?php echo $row['ID'] ?>"><i class="far fa-pen"></i></a>
                                        <a href="alumni_del.php?Id=<?php echo $row['ID'] ?>"><i class="far fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
