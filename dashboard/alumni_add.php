                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="alumni_list.php" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="Employment" name="Employment" required onchange="updateEmploymentStatus()">
                                        <option value="">Select Employment Status</option>
                                        <option value="Employed">Employed</option>
                                        <option value="Self-Employed">Self-Employed</option>
                                        <option value="Actively Looking">Actively Looking for a Job</option>
                                        <option value="Never Employed">Never Been Employed</option>
                                    </select>
                                </div>
